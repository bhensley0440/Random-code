...
#data prodyct ID (pdID) can be found on data browser
#site if four letter site code, default is all
#pakage is basic or expanded
#location to save to
zipsByProduct(dpID="DP1.10026.001", site="all", package="expanded", savepath="~/Steam Metabolizer")

#download directly into R
#same as zipsbyproduct
#no save path
#cfc is name of product
